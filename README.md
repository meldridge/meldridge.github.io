...
- `sid/`, `certutil/`, `whoami/`, `sudo/` — single-page tools (encoders/parsers). Each tool is a thin HTML shell plus a JS file in the same directory; its styles are a Sass partial in `_sass/` and follow the site's dark mode.

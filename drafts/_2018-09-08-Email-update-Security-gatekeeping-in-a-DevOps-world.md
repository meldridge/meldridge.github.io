...
One of my favourite points is when he discusses the importance of making the rest of the organisation *security self-sufficient*, and this quote in particular:
...
There's an obvious catch to this: your development teams need the skills and tools to do this properly. This is harder than it sounds—good developers with security skills are not easy or cheap—but you can get a long way with some basic training. To paraphrase [Robert Chesney](https://markeldo.com/Email-update-Technical-literacy-vs-fluency-blockchain-and-OSCP-proctoring/): you need developers who are security *literate*, but not necessarily *fluent*.

All of this means that the job of the security team becomes advising and educating, not gatekeeping.

## Not everything can be patched

Given my background, it'd be remiss of me not to point something which is often missed in these discussions: 
